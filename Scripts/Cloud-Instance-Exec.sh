...
if [ "$CLOUD_OS" == "GCP_UBU" ]; then
	if [ "$THEACTION" == "A" ]; then
		...
		ssh $THEREQUSR@$THEREQMAC -p $THEREQPRT -o StrictHostKeyChecking=no -i "$THEREQPEM" "sudo touch /opt/CLD && sudo chmod 777 /opt/CLD && echo \"GCP_UBU\" | sudo tee -a /opt/CLD > /dev/null && sudo touch /opt/LCL && sudo chmod 777 /opt/LCL && echo \"$THEREQBUC\" | sudo tee -a /opt/LCL > /dev/null && sudo touch /opt/GBL && sudo chmod 777 /opt/GBL && echo \"$THEREQGBK\" | sudo tee -a /opt/GBL > /dev/null && sudo touch /opt/EXEC1ON && sudo chmod 777 /opt/EXEC1ON && sudo mkdir -p /shiva && sudo chmod -R 777 /shiva && sudo mkdir -p /shiva/bdd && sudo chown -R root:root /shiva/bdd && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/bdd && sudo mkdir -p /shiva/bdd/storage && sudo chown -R root:root /shiva/bdd/storage && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/bdd/storage && sudo mkdir -p /shiva/local && sudo chown -R root:root /shiva/local && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/local && sudo mkdir -p /shiva/local/storage && sudo chown -R root:root /shiva/local/storage && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/local/storage && sudo mkdir -p /shiva/local/bucket && sudo chown -R root:root /shiva/local/bucket && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/local/bucket && sudo mkdir -p /shiva/global && sudo chown -R root:root /shiva/global && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/global && sudo mkdir -p /shiva/global/bucket && sudo chown -R root:root /shiva/global/bucket && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/global/bucket && sudo ln -s /shiva/global/bucket /shiva/global/storage && echo \"deb [signed-by=/usr/share/keyrings/cloud.google.asc] https://packages.cloud.google.com/apt gcsfuse-jammy main\" | sudo tee /etc/apt/sources.list.d/gcsfuse.list > /dev/null && curl https://packages.cloud.google.com/apt/doc/apt-key.gpg | sudo tee /usr/share/keyrings/cloud.google.asc && sudo apt-get update -y && sudo apt-get install gcsfuse -y && sudo gcsfuse --file-mode 777 --dir-mode 777 $THEREQBUC \"/shiva/local/bucket\" && sudo gcsfuse --file-mode 777 --dir-mode 777 $THEREQGBK \"/shiva/global/bucket\" && sudo touch /shiva/local/bucket/$THEREQBUC && sudo touch /shiva/global/bucket/$THEREQGBK && sudo mv /opt/EXEC1ON /opt/EXEC1DONE"
...
if [ "$CLOUD_OS" == "AZURE_UBU" ]; then
	if [ "$THEACTION" == "A" ]; then
		...
		ssh $THEREQUSR@$THEREQMAC -p $THEREQPRT -o StrictHostKeyChecking=no -i "$THEREQPEM" "sudo touch /opt/CLD && sudo chmod 777 /opt/CLD && echo \"AZURE_UBU\" | sudo tee -a /opt/CLD > /dev/null && sudo touch /opt/LCL && sudo chmod 777 /opt/LCL && echo \"$THEREQLSC\" | sudo tee -a /opt/LCL > /dev/null && sudo touch /opt/GBL && sudo chmod 777 /opt/GBL && echo \"$THEREQGSC\" | sudo tee -a /opt/GBL > /dev/null && sudo touch /opt/EXEC1ON && sudo chmod 777 /opt/EXEC1ON && sudo mkdir -p /shiva && sudo chmod -R 777 /shiva && sudo mkdir -p /shiva/bdd && sudo chown -R root:root /shiva/bdd && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/bdd && sudo mkdir -p /shiva/bdd/storage && sudo chown -R root:root /shiva/bdd/storage && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/bdd/storage && sudo mkdir -p /shiva/local && sudo chown -R root:root /shiva/local && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/local && sudo mkdir -p /shiva/global && sudo chown -R root:root /shiva/global && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/global && sudo mkdir -p /shiva/filecachelocal && sudo chown -R root:root /shiva/filecachelocal && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/filecachelocal && sudo mkdir -p /shiva/filecacheglobal && sudo chown -R root:root /shiva/filecacheglobal && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/filecacheglobal && sudo mkdir -p /shiva/local/storage && sudo chown -R root:root /shiva/local/storage && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/local/storage && sudo mkdir -p /shiva/global/storage && sudo chown -R root:root /shiva/global/storage && sudo chmod -R u=rwx,g=rwx,o=rwx /shiva/global/storage && sudo touch /opt/localSC.yaml && echo \"
allow-other: true
